...
<head>
    ...
    <title>Worker Agreement - Trustyhands Premium Service Platform</title>
...
<body>
    ...
    <section class="about-hero">
        <div class="container">
            <h1>Worker Agreement</h1>
            <p>Terms for professionals using our platform</p>
        </div>
    </section>
    ...
    <section class="legal-section">
        <div class="container">
            <div class="legal-content">
                ...
                <p>By registering as a worker on Trustyhands, you agree to be bound by this Worker Agreement. This
                    agreement governs your relationship with Trustyhands as an independent service provider.</p>

                <h2>2. Worker Responsibilities</h2>
                <h3>2.1 Service Quality</h3>
                <p>You agree to:</p>
                <ul>
                    <li>Provide services with reasonable skill, care, and diligence</li>
                ...
                <ul>
                    ...
                    <li>Set realistic availability and service areas</li>
                ...
                <p>You must not:</p>
                <ul>
                    <li>Circumvent Trustyhands payment system</li>
                    <li>Solicit clients for direct transactions</li>
                    <li>Misrepresent qualifications or experience</li>
                    <li>Discriminate against clients</li>
                </ul>

                <h2>4. Payments & Fees</h2>
                <h3>4.1 Service Fees</h3>
                <p>Trustyhands charges a service fee of 15-20% per transaction. You set your own rates for services,
                    which should be competitive and reasonable.</p>

                <h3>4.2 Payment Processing</h3>
                <p>Payments are processed weekly via:</p>
                <ul>
                ...
                <p>You agree that clients may rate and review your services. Trustyhands reserves the right to remove
                    workers with consistently poor ratings (below 3.5/5).</p>

                <h2>6. Insurance & Liability</h2>
                <p>Trustyhands provides general liability coverage up to ₹500,000 per incident for qualified
                    professionals. You must report any incidents within 24 hours to qualify for coverage.</p>

                <h2>7. Termination</h2>
                <p>Either party may terminate this agreement at any time with written notice. Trustyhands may
                    immediately terminate accounts for violations of this agreement.</p>

                <h2>8. Amendments</h2>
                <p>We may update this agreement periodically. Continued use of the platform constitutes acceptance of
                    updated terms.</p>
