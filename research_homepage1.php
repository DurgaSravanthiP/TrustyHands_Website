...
<body>
    ...
    <header>
        <div class="container header-container">
            ...
            <nav>
                <ul>
                    <li><a href="research_homepage1.php" class="active">Home</a></li>
        ...
        <div class="container">
            ...
            <div class="customer-content">
                ...
                <div class="customer-text">
                    <h3 style="font-size: 1.6rem; color: var(--primary); margin-bottom: 18px;">Find Trusted
                        Professionals For All Your Needs</h3>
                    <p style="font-size: 0.95rem; line-height: 1.6; margin-bottom: 22px;">At Trustyhands, we understand
                        that finding reliable help for your home and business needs can be challenging. Our platform
                        connects you with verified professionals who are ready to help with any task, big or small.</p>
                    ...
                    <div class="benefits-grid">
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Verified Workers
                                </h4>
                        ...
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Ratings & Reviews
                                </h4>
                        ...
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Secure Payments
                                </h4>
                    ...
                    <button class="btn btn-primary trigger-modal" style="margin-top: 25px; padding: 10px 25px;">Find a
                        Worker
                        Now</button>
                </div>
                <div class="customer-image">
                    <img src="https://media1.thehungryjpeg.com/thumbs2/ori_3746963_xyilhzpcdlfl28ei1uch003889m2z4mgdfwvxnb7_happy-client-vector-customer-person-shaking-hands-partnership-important-client-business-connection-isolated-flat-cartoon-character-illustration.jpg"
                        alt="Customer Image" style="width: 100%; height: auto; border-radius: 14px;">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="worker-content">
                <div class="worker-image">
                    <img src="https://static.vecteezy.com/system/resources/previews/023/981/182/original/group-of-people-in-different-professions-businessman-construction-worker-female-doctor-teacher-waiter-chef-cartoon-illustration-free-png.png"
                        alt="Worker Image" style="width: 100%; height: auto; border-radius: 14px;">
                </div>
                <div class="worker-text">
                    <h3 style="font-size: 1.6rem; color: var(--text); margin-bottom: 18px;">Join Our Community of
                        Skilled Professionals</h3>
                    <p style="font-size: 0.95rem; line-height: 1.6; margin-bottom: 22px;">Trustyhands provides a
                        platform for skilled workers to connect with customers who need their services. Expand your
                        client base, set your own schedule, and grow your business with our professional platform.</p>
                    ...
                    <div class="benefits-grid">
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Competitive Pay
                                </h4>
                        ...
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Flexible Schedule
                                </h4>
                        ...
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Build Your
                                    Reputation</h4>
                        ...
                        <div class="benefit-card">
                            ...
                            <div>
                                <h4 style="color: var(--text); margin-bottom: 6px; font-size: 1rem;">Insurance
                                    Protection</h4>
                    ...
                    <button class="btn btn-secondary trigger-modal" style="margin-top: 25px; padding: 10px 25px;">Join
                        as a
                        Worker</button>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-container">
                <div class="testimonial">
                    ...
                    <p style="font-size: 0.95rem; line-height: 1.6;">"Trustyhands saved me when my kitchen sink burst on
                        a Sunday! Found a plumber within 20 minutes who fixed everything professionally. The platform is
                        incredibly easy to use and the quality of service exceeded my expectations."</p>
                    <div class="client">
                ...
                <div class="testimonial">
                    ...
                    <p style="font-size: 0.95rem; line-height: 1.6;">"Since joining Trustyhands, I've doubled my monthly
                        income. The platform connects me with serious clients who value my skills. The payment system is
                        reliable and the support team is always helpful. Best decision I made for my business!"</p>
                    <div class="client">
                ...
                <div class="testimonial">
                    ...
                    <p style="font-size: 0.95rem; line-height: 1.6;">"I've used Trustyhands for multiple services -
                        cleaning, plumbing, and AC repair. Every professional arrived on time, did excellent work, and
                        charged fairly. The app makes it so easy to book and manage services. Highly recommended!"</p>
                    <div class="client">
