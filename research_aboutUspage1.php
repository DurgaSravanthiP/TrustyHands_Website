...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="research_aboutUspage1.php" class="active">About Us</a></li>
        ...
        <div class="container">
            ...
            <div class="story-content">
                <div class="story-text">
                    <p>In India, finding reliable skilled workers like plumbers, electricians, cleaners, and
                        construction workers at the right time has always been a challenge. Most people rely on
                        neighbors, WhatsApp groups, or unverified contacts, which is slow and unreliable. At the same
                        time, many skilled workers struggle to find regular employment, often depending on word of mouth
                        or waiting at labor points hoping for work.</p>
                    <br>
                    <p>Trustyhands was born to solve this dual problem. Founded in 2023 by three passionate
                        entrepreneurs - Shruthi Deepika, Durga Sravanthi, and Khyathi Sree - our platform instantly
                        connects users with nearby verified workers, making the process faster, safer, and more
                        convenient for everyone involved.</p>
                    <br>
                    <p>Today, Trustyhands has grown to become one of India's leading service platforms, connecting
                        thousands of skilled workers with customers across multiple cities. Our mission is to empower
                        both workers and customers through technology, creating opportunities and solving everyday
                        problems.</p>
                </div>
            ...
            <div class="founders-grid">
                <div class="founder-card">
                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1376&q=80"
                        alt="Shruthi Deepika" class="founder-img">
                    <h3 class="founder-name">Shruthi Deepika</h3>
                    <p class="founder-role">CEO & Co-Founder</p>
                    <p>With a background in technology and social entrepreneurship, Shruthi leads our vision to
                        transform India's service industry.</p>
                </div>
                <div class="founder-card">
                    <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1376&q=80"
                        alt="Durga Sravanthi" class="founder-img">
                    <h3 class="founder-name">Durga Sravanthi</h3>
                    <p class="founder-role">CEO & Co-Founder</p>
                    <p>Durga brings technical expertise and a passion for creating user-friendly platforms that solve
                ...
                <div class="founder-card">
                    <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1361&q=80"
                        alt="Khyathi Sree" class="founder-img">
                    <h3 class="founder-name">Khyathi Sree</h3>
                    <p class="founder-role">CEO & Co-Founder</p>
                    <p>Khyathi focuses on operations and community building, ensuring both workers and customers have
    ...
    <section class="section">
        <div class="container">
            ...
            <p style="text-align: center; max-width: 800px; margin: 0 auto 30px;">Our platform simplifies the process of
                finding skilled workers while creating opportunities for service providers</p>
    ...
    <section class="work-with-us">
        <div class="container">
            <div class="work-content">
                ...
                <p style="font-size: 1.1rem; max-width: 700px; margin: 0 auto 20px;">Join our mission to transform
                    India's service industry and create opportunities for millions</p>
                ...
                <div class="work-options">
                    <div class="work-option">
                        ...
                        <h3>Join Our Team</h3>
                        <p>We're always looking for talented individuals who share our passion for innovation and social
                            impact.</p>
                        <button class="btn btn-secondary" style="margin-top: 15px; padding: 8px 20px;">View
                            Openings</button>
                    </div>
                    <div class="work-option">
                        <div class="work-icon">
                        ...
                        <p>Join our platform as a skilled professional and access thousands of job opportunities in your
                            area.</p>
                        <button class="btn btn-primary" style="margin-top: 15px; padding: 8px 20px;">Sign Up
                            Now</button>
                    </div>
                </div>
            </div>
