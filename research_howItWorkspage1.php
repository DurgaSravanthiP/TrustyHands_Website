...
<body>
    ...
    <section class="how-it-works">
        <div class="container">
            ...
            <p style="text-align: center; max-width: 800px; margin: 0 auto 40px; font-size: 1.1rem; color: var(--text-light);">
                Getting the service you need is quick and easy with Trustyhands. Follow these simple steps to find trusted professionals.
            </p>
            ...
            <p style="text-align: center; max-width: 800px; margin: 0 auto 40px; font-size: 1.1rem; color: var(--text-light);">
                Join our platform to offer your services and grow your business. Here's how to get started as a Trustyhands professional.
            </p>
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Most services can be scheduled within 24 hours. For urgent requests, we have professionals available for same-day service in many areas.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Simply sign up on our platform, complete your profile, and go through our verification process. Once approved, you can start accepting service requests.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>All workers are verified through background checks. We also have a rating system and 24/7 support to ensure safety for both customers and workers.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Customers pay securely through our platform. Workers receive payment directly to their account after service completion, minus our small service fee.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    ...
                    <p style="font-size: 0.9rem; max-width: 300px; margin-bottom: 18px; color: var(--text-footer);">Connecting customers with trusted local workers across Andhra Pradesh</p>
