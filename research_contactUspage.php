...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="research_contactUspage.php" class="logo">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="research_contactUspage.php" class="active">Contact Us</a></li>
                </ul>
            </nav>
            <div class="auth-buttons">
                ...
                <div class="user-profile">
                    ...
                    <a href="research_logout.php" class="btn btn-outline">Logout</a>
                </div>
                <?php else: ?>
                    ...
                    <div class="contact-card">
                        ...
                        <form id="contactForm">
                            ...
                            <button type="submit" class="btn btn-primary"
                                style="width: 100%; padding: 12px; font-size: 0.95rem;">Send Message</button>
                        </form>
                        ...
                        <div class="contact-info">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p>For urgent matters, our support team is available around the clock to assist you
                                        with any service-related issues.</p>
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>We respond to all inquiries within 24 hours during business days. For urgent matters, please
                            call our 24/7 support line at +91 91001 12233.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes! While our headquarters is in Guntur, we provide services across all districts of Andhra
                            Pradesh including Vijayawada, Visakhapatnam, Tirupati, and Nellore.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>We recommend scheduling an appointment to ensure we can give you proper attention. However,
                            walk-ins are welcome during business hours.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes, our customer support team is fluent in Telugu, Hindi, and English to serve you better.
                        </p>
                    </div>
                </div>
            </div>
